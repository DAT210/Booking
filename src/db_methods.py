...
def db_insert_full_day(): # Default fullDay
    ...
    try:
        ...
        app.config["DATABASE"].commit()
        mycursor.execute(
            "INSERT INTO rest_book VALUES(1,30,'01','2018-11-17',1,2),(1,31,'02','2018-11-17',1,2),(1,32,'03','2018-11-17',1,3),(1,33,'04','2018-11-17',1,3),(1,34,'05','2018-11-17',1,3),(1,50,'05','2018-11-20',1,6),(1,51,'05','2018-11-20',1,4),(1,52,'05','2018-11-20',1,4),(1,53,'05','2018-11-20',1,6),(1,54,'05','2018-11-20',1,3),(1,55,'05','2018-11-20',1,3),(1,56,'05','2018-11-20',1,3),(1,57,'05','2018-11-21',1,8),(1,58,'05','2018-11-21',1,8),(1,59,'05','2018-11-21',1,8),(1,60,'05','2018-11-21',1,8),(1,61,'05','2018-11-21',1,8),(1,62,'05','2018-11-21',1,3)")
        app.config["DATABASE"].commit()
    except mysql.connector.Error as err:
        print("Error: {}".format(err.msg))
    finally:
